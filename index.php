                ...
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="my-5 text-center text-xl-start">
                        <h1 class="display-6 fw-bolder text-white mb-2">Tu sonrisa es nuestra prioridad en radiologia
                            dental</h1>
                        <p class="lead fw-normal text-white-50 mb-4">Ofrecemos servicios de diagnóstico y tratamiento,
                            usando tecnologia de vanguardia para obtener imágines precisas de los dientes y la
